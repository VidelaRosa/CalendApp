...
"""
"""
Django settings for CalendApp project.
...
SECRET_KEY = '6_ib#(8(v%&tph0m^=(+moif$=^uj7--iw%y$8pezf5^^!v))q'
...
ROOT_URLCONF = 'CalendApp.urls'

WSGI_APPLICATION = 'CalendApp.wsgi.application'
...
STATIC_URL = '/static/'
MEDIA_ROOT = 'www' + STATIC_URL + 'media/'
MEDIA_URL = '/media/'
